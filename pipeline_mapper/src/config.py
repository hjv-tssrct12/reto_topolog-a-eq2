...
# Regresión (AF continuo)
RF_REG_N_ESTIMATORS = [100, 300, 500]
RF_REG_MAX_DEPTH    = [None, 5, 10]

GBR_N_ESTIMATORS = [100, 300]
GBR_LEARNING_RATE = [0.01, 0.05, 0.1]

# Clasificación (AF categórico)
RF_CLF_N_ESTIMATORS = [100, 300, 500]
RF_CLF_MAX_DEPTH    = [None, 5, 10]

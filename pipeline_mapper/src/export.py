...
def export_excel(
    ...
    hp_rows = [
        ...
        {"Parámetro": "clusterer_sweep",        "Valor": chosen_config.get("clusterer_name", "AdaptiveDBSCAN")},
        ...
        {"Parámetro": "clusterer_gs",
         "Valor": gs_config.get("clusterer_name", "AdaptiveDBSCAN") if gs_config else "N/A"},
        ...
        {"Parámetro": "── Clusterer / Stability ──", "Valor": ""},
        {"Parámetro": "clusterer_adaptive",     "Valor": "True"},
